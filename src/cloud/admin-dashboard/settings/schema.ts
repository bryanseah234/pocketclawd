...
export const SETTINGS_REGISTRY: ReadonlyArray<SettingDefinition> = [
    ...
    },
    {
        ...
        description: 'IANA timezone for digest delivery',
        type: 'enum',
        default_value: 'Asia/Singapore',
        env_fallback: 'NOTIFICATIONS_DIGEST_TIMEZONE',
        options: ['Asia/Singapore','Asia/Kuala_Lumpur','Asia/Jakarta','Asia/Bangkok','Asia/Tokyo','Asia/Shanghai','UTC','Europe/London','America/New_York','America/Los_Angeles','Australia/Sydney'],
        requires_restart: false,
    ...
    // -- Setup --
    // These fields are rendered on the Set Up tab, not in the Settings panel.
    {
        key: 'setup.telegram_bot_token',
        category: 'setup',
        label: 'Telegram Bot Token',
        description: 'From @BotFather on Telegram. Used to notify you when a new user messages Clawd (when auto-approve is off).',
        type: 'secret',
        default_value: '',
    ...
    {
        key: 'setup.auto_approve_senders',
        category: 'setup',
        label: 'Auto-approve New Users',
        description: 'When on, anyone can message Clawd immediately. When off, you approve each new sender via Telegram.',
        type: 'boolean',
        default_value: 'true',
        env_fallback: 'AUTO_APPROVE_SENDERS',
        options: null,
        requires_restart: false,
        validation_pattern: null,
        min: null,

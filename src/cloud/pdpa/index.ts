...
/**
 * WARNING: These Maps are in-process state — they are lost on orchestrator restart.
 * A user mid-consent-flow when the orchestrator restarts will receive a duplicate
 * consent prompt or orphaned deletion confirmation.
 * TODO: Persist to DynamoDB with TTL (e.g. nanoclaw-pdpa-flows table, 24h TTL).
 * See improvement opportunity #7 in the system assessment.
 */

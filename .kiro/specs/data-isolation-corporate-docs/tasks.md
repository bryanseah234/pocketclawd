...
- [ ] 1. DataGateway core changes — CORPORATE sentinel and search filter
  - [~] 1.1 Add CORPORATE_SENTINEL constant and modify assertUserId validation
  ...
  - [~] 1.2 Implement corporate-inclusive hybrid search filter
  ...
  - [~] 1.3 Add indexCorporateDocument method
  ...
  - [~] 1.4 Modify S3 key validation to allow corporate/ prefix for reads
  ...
  - [~] 1.5 Modify deleteAllUserData to exclude CORPORATE documents
  ...
  - [~] 1.6 Write property tests for DataGateway corporate isolation
  ...
  - [~] 1.7 Write unit tests for DataGateway corporate search and sentinel
...
- [~] 2. Checkpoint — DataGateway core
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 3. DataGateway Worker — CORPORATE origin validation
  - [~] 3.1 Add origin validation for CORPORATE index requests
  ...
  - [~] 3.2 Add userId mismatch validation for sub-agent requests
  ...
  - [~] 3.3 Write unit tests for DataGateway Worker origin validation
    - Add tests verifying:
...
- [ ] 4. Upload Worker — corporate routing logic
  - [~] 4.1 Extend PendingUpload interface with corporate flag
    - Add `corporate?: boolean` field to the `PendingUpload` interface in `src/cloud/upload-worker/index.ts`
    - _Requirements: 1.1, 6.2_

  - [~] 4.2 Implement corporate upload routing in Upload Worker
  ...
  - [~] 4.3 Write property tests for Upload Worker corporate routing
  ...
  - [~] 4.4 Write unit tests for Upload Worker corporate flow
...
- [ ] 7. Message routing validation (existing behavior confirmation)
  - [~] 7.1 Verify and document existing message routing isolation
  ...
  - [~] 7.2 Write property test for message routing isolation
  ...
  - [~] 7.3 Write unit tests for routing edge cases
